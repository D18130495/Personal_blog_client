    ...
    <div class="whitebg bloglist">
        ...
        <ul>
            <li v-for="(toppedArticle, index) in toppedArticles" :key="index.id">
                <h3 class="blogtitle">
                    <router-link :to='"/detail/" + toppedArticle.id' arget="_blank">
                        <b>【Topped】</b>
                        {{ toppedArticle.title }}
                    </router-link>
                </h3>
                ...
                <span class="blogpic imgscale"><i><router-link :to='"/detail/" + toppedArticle.id'>{{ toppedArticle.channel.name}}</router-link></i>
                    <router-link :to='"/detail/" + toppedArticle.id'>
                ...
                <router-link :to='"/detail/" + toppedArticle.id' class="viewmore">More</router-link>
            </li>
            ...
            <li v-for="(article, index) in articles" :key="index">
                ...
                <router-link :to='"/detail/" + article.id' class="viewmore"> More</router-link >
            </li>
        </ul>
